...
namespace DotaApi.Model
{
	public class MatchHistory
	{
		...
		/// <seealso cref="http://uglyvpn.com/"/>
		/// </summary>
		public static List<DotaApi.Model.MatchDetails.MatchDetailsResult> GetMatchHistoryBySeqNum(int matchseqnumb, int requestedmatches, List<ItemsClass.Item> DotaItems)
		{
			//to do
			//create a player class to hold more information regarding the individual
			//players including abilities/build info
